...
<form class="card" method="post" enctype="multipart/form-data" action="../vendor/update_pers_jur.php">
    <h2>Modificarea datelor persoanei juridice</h2>
